...
struct PolygonalMesh
{
    ...
    vector<Vector2i> Cell1DVertices = {}; ///< Cell1D vertices indices, size 2 x NumberCell1D (fromId(origin),toId(end)s)
    ...
    // tol = epsilon di macchina
    double tolDefault = numeric_limits<double>::epsilon();
};
